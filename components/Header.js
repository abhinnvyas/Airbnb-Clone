  ...
  return (
    ...
    >
      ...
      <div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
        ...
        />
        <SearchIcon className="hidden md:inline-flex h-8 cursor-pointer text-white bg-red-400 rounded-full p-2 md:mx-2" />
      </div>
      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 w-full sm:w-max mx-auto mt-4">
          <DateRangePicker
